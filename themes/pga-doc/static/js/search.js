        ...
        boost: 5
            ...
            pagesIndex.forEach(function(page) {
                ...
                if(page.uri == window.location.href) {
                    ...
                    let currentVersion = baseurl.includes('latest') ? 'latest' : $('#pgaVersion option:selected').text().replace(' (development)','');
                    $('#pgaVersion option:not(:selected)').each(function(index, alt) {
